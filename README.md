...
│   │   ├── ACE_Community_and_Development_Act_v3_7_2026-09.docx
│   │   ├── ACE_Declaration_v1_2_2026-09.docx
...
│   │   └── ACE_Letter_Dr_Johnson_v1_0_2026-09.docx
│   ├── ACE_Community_and_Development_Act_v3_7_2026-09.pdf   ← only PDFs in root
│   ├── ACE_Declaration_v1_2_2026-09.pdf
...
│   └── ACE_Letter_Dr_Johnson_v1_0_2026-09.pdf
├── landing/
...
│   │   ├── ACE_Jurisdictional_Sovereignty_Brief_v1_1_2026-09.docx
...
│   ├── ACE_Jurisdictional_Sovereignty_Brief_v1_1_2026-09.pdf
...
Advanced v3.4 → v3.6 → v3.7 in a later working session (not yet reflected in a version log entry before this one). v3.6 folds a sovereign-nation-recognition clause into Sec. CP-3's Call to Action, tying explicit congressional recognition of Black Americans as a sovereign nation directly to the Continuity Doctrine already established in Title XXI. v3.7 is a full BATEI (Black American Tax Equity Initiative) rebuild: the original "the exemption follows the person, not the location" claim, framed as a portable tribal-citizenship-based exemption, was found factually false on research (IRC § 7871 exempts tribal governments and entities, not individual members; McClanahan v. Arizona State Tax Commission, 411 U.S. 164 (1973), establishes only a source-based state exemption for income earned on a member's own reservation). Per founder direction ("we will not manufacture a legal mechanism at any turn"), BATEI was rebuilt around a reparations/restitution theory instead: federal tax relief grounded in the Civil Liberties Act of 1988 and the Katrina Emergency Tax Relief Act of 2005, framed as one third of the 250 years of unpaid labor (stated as a fraction only, no specific year count, to preserve negotiating room), with the federal and state-level tracks made explicitly independent and severable. Ten sites across the Act were corrected to remove the false claim and ground the ask in the verified precedent, including two sites (a donor capital-gains passage and an estate/inheritance-tax bullet near Sec. 1408) not found until a second verification pass. Page numbers were intentionally stripped from this delivered version at founder direction pending the founder's own manual pagination pass; the copy in this repo is the founder's own subsequently paginated version (128 pages), confirmed as the canonical v3.7 for circulation.

### The Unanimous Declaration v1.2 (new)
The Alliance's founding declaration, in the register of the 1776 Declaration of Independence: an opening statement of cause, fourteen documented grievances spanning both the Black American and Native American historical record, a doctrinal passage distinguishing separation from segregation, and a closing declaration of self-governance. Built as v1.0 (4 pages), then v1.1 added the separation/segregation doctrine as its own passage between the grievances' bridge line and the closing declaration, worked through several rounds of the founder's own wordsmithing before being locked verbatim. The founder then applied his own formatting pass (full header/footer redesign, tricolor bars, crest in the running header, founders@/acecommunities.org contact line) and uploaded that as v1.2, at which point the "Draft" label — carried over reflexively from the build script and no longer accurate once content was locked — was removed from the byline per founder confirmation. v1.2 is the founder's own edited file and is the version in this repo.
...
### Dr. Umar Johnson Letter v1.0 (new)
Personal outreach letter to Dr. Umar Johnson, founder of FDMG Academy, on the personal-letter format (smaller centered crest, "PERSONAL & CONFIDENTIAL" designation, no page numbers, founder's direct line in the signature block per the established personal-letter exception to the phone-number rule). Opens from the founder's own regard for Dr. Johnson's decade-long argument for culturally rooted, independently owned Black institutions, draws the parallel and the honest distinction between FDMG Academy's outcome and ACE's funding model, and asks Dr. Johnson to read the Act and say plainly whether it closes the gap FDMG fell into. The personal-disclaimer paragraph ("please do not mistake me for an activist, a politician, or a leader") was given its own earned bridge sentence, rather than appearing as an abrupt subject change, matching the care already applied to the same disclaimer in the Ice Cube and Roland Martin letters.
...
| Jurisdictional Sovereignty Brief | v1.1 | Tribal land jurisdiction claims, plus a second, independent sovereignty ground under the Continuity Doctrine (new Section VI, added after Act v3.6 folded Continuity Doctrine recognition into Sec. CP-3) |
...
| v76 | The Unanimous Declaration added as a new Core Document, v1.0 through v1.2 across one working session. v1.0 built fresh (opening statement of cause, fourteen grievances spanning both peoples' history, closing declaration). v1.1 added a new doctrinal passage distinguishing separation from segregation, worked through several rounds of the founder's own wordsmithing before being locked to his final wording. v1.2 is the founder's own uploaded file after he applied his own formatting pass (tricolor header/footer redesign, crest in running header, founders@/acecommunities.org contact line); the reflexive "Draft" label was dropped from the byline per founder confirmation since content was locked, and the founder's added comma in the grievances' bridge line was kept per his explicit choice. Docx and PDF added to `documents/` and `documents/docx/`; PDF added to `active-versions/`. |
| v77 | ACE Act advanced v3.4 → v3.6 → v3.7. v3.6 folds explicit sovereign-nation-recognition language into Sec. CP-3's Call to Action, tied to the Continuity Doctrine already established in Title XXI (Black Americans as the continuation of a sovereign political community never lawfully dissolved). v3.7 is a full rebuild of BATEI's legal theory after research found the existing "exemption follows the person, not the location" claim factually false (no blanket individual tribal-citizenship tax exemption exists in law; IRC § 7871 exempts tribal governments/entities, not members; McClanahan v. Arizona State Tax Commission, 411 U.S. 164 (1973), is source-based and state-specific). Per founder direction not to manufacture a legal mechanism, BATEI was rebuilt on a reparations/restitution theory: the Civil Liberties Act of 1988 and the Katrina Emergency Tax Relief Act of 2005, with the ask framed as one third of the 250 years of unpaid labor (fraction only, no specific year count, per founder direction to preserve negotiating room), and the federal and state-level relief tracks made explicitly independent and severable per founder instruction ("if one dies the other should live on"). Ten sites across the Act corrected in total, including two not found until a second verification pass. Page numbers were stripped from the delivered docx at founder direction pending his own manual pagination; the version in this repo is the founder's own subsequently paginated file (128 pages), confirmed by him as canonical for circulation. Superseded v3.4 removed from `active-versions/`. |
| v78 | Dr. Umar Johnson personal letter added, v1.0. Built on the personal-letter format (smaller crest, "PERSONAL & CONFIDENTIAL," no page numbers, founder's direct line in the signature block). The personal-disclaimer paragraph was given an earned bridge sentence ("I say that plainly because I would rather you hear it from me than discover it on your own") connecting it to the preceding funding-model paragraph, rather than landing as an abrupt subject change, matching the same fix already made in the Ice Cube and Roland Martin letters. Added to `documents/` and `documents/docx/`. |
| v79 | **This entry.** Jurisdictional Sovereignty Brief advanced v1.0 → v1.1: new Section VI, "The Continuity Doctrine: A Second, Independent Ground for Sovereign Recognition," added after Act v3.6 made Continuity Doctrine sovereign-nation recognition part of the Act's main Call to Action rather than only the Title XXI contingency scenario. The brief's original theory (Sections I–V) only defended sovereignty through the tribal-land-lease path and had no defense prepared for a challenge to the Continuity Doctrine claim specifically, even though that claim is separately defended in depth in the Title XXI Contingency Brief (No. 4, already at v1.3 — the version log's earlier "v1.0" listing for that brief was stale and is corrected here). New Section VI states the claim, grounds it in Dred Scott v. Sandford's own distinction between Black American and tribal political continuity, explains why it is not a claim under 25 C.F.R. Part 83, states the two sovereignty grounds are severable, and summarizes the three anticipated challenges with a pointer to Brief No. 4 for full depth. Four precedents added to the Key Precedents section (Dred Scott, Morton v. Mancari, Fullilove v. Klutznick, Federally Recognized Indian Tribe List Act of 1994); sections VI–VII renumbered to VII–VIII. Superseded v1.0 removed from `legal/`, `legal/docx/`, and `active-versions/`. Full reconciliation pass: this entry also lands the accumulated backlog from the same working session (v76–v78 above) that had not yet been committed — Declaration v1.0–v1.2, ACE Act v3.6–v3.7, and the Dr. Umar Johnson letter v1.0 — none of which had been pushed to git despite being finished and delivered to the founder. |
...
- Personal letters still outstanding: Shannon Sharpe, Tavis Smiley, Dr. Cornel West, Mark Charles (first Native American personal-letter recipient), Dr. Claud Anderson — none drafted yet; Dr. Umar Johnson letter is done (v1.0, this entry)
- Landing page not yet updated to reflect Declaration v1.2, Act v3.7, or the Johnson letter — still linking Act v3.4-era references as of v9.15
- A shorter, more clinical/definitions-style version of the separation-vs-segregation doctrine for the Act itself (distinct from the Declaration's rhetorical v1.1 passage) — not yet started
- A plain-language landing-page treatment of the separation/segregation doctrine — not yet started
- Declaration does not yet have its own dedicated landing page — not yet started
